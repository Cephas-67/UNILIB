...
import { Camera, Download, Heart, Upload, FolderKanban, Bell, Shield, Trash2, Check, Moon, Sun } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-20 lg:pb-0">
      ...
      <div className="bg-background rounded-xl border border-border p-6 shadow-sm flex flex-col md:flex-row items-center gap-6">
        <div className="relative">
          ...
          <button className="absolute bottom-0 right-0 w-7 h-7 rounded-full bg-foreground text-background flex items-center justify-center hover:scale-110 transition-transform">
            <Camera size={14} />
          </button>
        </div>
